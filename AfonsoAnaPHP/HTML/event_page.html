        ...
        <main>
           ...
           (Tabs control the hidden select used by JS) -->
            <section class="events-toggle-wrapper">
                <h2 class="sr-only">Event timeframe controls</h2>
                <div class="events-toggle" role="group" aria-label="Filter events">
            ...
            <section class="events-actions">
                <h2 class="sr-only">Event actions</h2>
            ...
            <section class="events-section">
                <h2 class="sr-only">Event listings</h2>
                <div class="list-pagination" data-pagination-for="eventsList">
                    ...
                    <div class="pagination-actions">
                        <button type="button" class="explore-btn ghost icon-only" data-page-prev
                            aria-label="Ver anteriores">
                            <i class="bi bi-chevron-left" aria-hidden="true"></i>
                        </button>
                        <span class="pagination-status" data-pagination-status>Mostrando 0-0 de 0</span>
                        <button type="button" class="explore-btn ghost icon-only" data-page-next
            ...
            <div id="event-modal" class="modal">
                <div class="modal-content">
                    ...
                    <div id="modal-event-body">
                        ...
                        <p>
                            <strong>Owner:</strong>
                            <a id="modal-event-host" class="event-owner-link" href="#" target="_self"></a>
                        </p>
                ...
                <div class="modal-content">
                    ...
                    <form id="form-event">
                        ...
                        <div class="form-section form-section--required">
                            ...
                            <input type="text" id="evt-location" name="evt-location" required>
                            <label for="evt-collections">Associated collections</label>
                            <select id="evt-collections" name="evt-collections" multiple size="4" required>
                                <!-- Filled via JavaScript -->
                            </select>
                            <small class="form-hint">Press Ctrl/Cmd (⌘) or Shift to select multiple collections.</small>
                        </div>
