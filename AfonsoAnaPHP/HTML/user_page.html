<!DOCTYPE html>
<!--
  File: public_html/HTML/user_page.html
  Purpose: User profile page — shows user info, featured collections, liked collections and user events.
  Major sections: NAVIGATION, PROFILE OVERVIEW, USER SHOWCASE, LIKED COLLECTIONS, USER EVENTS.
...
<body>
  <div id="content">
    ...
    <header>
      <nav class="navbar">
        ...
        <div class="nav-right">
          ...
          <a href="user_page.html" class="nav-link" aria-current="page">
    ...
    <main>
      ...
      <!-- PROFILE OVERVIEW -->
      <!-- Use the same page title style as other pages and show a static label -->
      ...
      <section class="profile-hero">
        <div class="profile-card">
          ...
          <!-- Actions: same style as Home/All Collections -->
      ...
      <section id="user-liked-items" class="liked-items collection-container" data-item-source="liked"
        data-owner-context="true" aria-labelledby="user-liked-items-title">
    ...
    <div class="modal-content">
      ...
      <form id="form-collection">
        ...
        <div class="modal-actions">
          <button type="submit" class="explore-btn success"> <i class="bi bi-save me-1"></i>Save</button>
