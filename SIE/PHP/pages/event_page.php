...
<body>
  ...
  <script id="event-page-data" type="application/json">
    <?php
    echo json_encode(
      [
        'eventsForCalendar' => array_values($eventsForCalendar),
        'isAuth' => $isAuth,
        'createAllowedFromDate' => $createAllowedFromDate,
  ...
  <script src="../../JS/event-page.js" defer></script>
</body>
