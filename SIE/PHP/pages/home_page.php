...
<head>
  ...
  <!-- home_page.css omitted to match all_collections layout -->
  ...
  <style>
    ...
    .page-main, .inner-block { max-width: 1200px; margin: 0 auto; padding: 20px 20px 60px; }
    .collection-container { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 360px)); gap: 24px; justify-content: center; }
