...
<?php include __DIR__ . '/../includes/footer.php'; ?>
        <script id="specific-collection-data" type="application/json">
            <?php
            echo json_encode(
                [
                    'scrollKey' => 'gc-scroll-specific-' . (int)$collectionId,
                    'likesAction' => 'likes_action.php'
                ],
                JSON_HEX_TAG | JSON_HEX_APOS | JSON_HEX_QUOT | JSON_HEX_AMP | JSON_UNESCAPED_UNICODE
            );
            ?>
        </script>
        <script src="../../JS/specific-collection.js" defer></script>
    </body>
