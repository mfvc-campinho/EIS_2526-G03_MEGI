      ...
      <?php else: ?>
        <?php foreach ($collections as $col): ?>
          <article class="collection-card">
            <a href="specific_collection.php?collection_id=<?php echo urlencode($col['collection_id']); ?>" class="collection-link">
              <div class="collection-thumb">
                <?php if (!empty($col['cover_image'])): ?>
                  <img src="<?php echo htmlspecialchars($col['cover_image']); ?>" alt="<?php echo htmlspecialchars($col['name']); ?>">
                <?php else: ?>
              ...
              <div class="collection-summary">
                ...
                <div class="meta muted">
                  <span>By <?php echo htmlspecialchars($col['user_id'] ?? ''); ?></span>
                  <time datetime="<?php echo htmlspecialchars($col['created_at']); ?>"><?php echo htmlspecialchars($col['created_at']); ?></time>
                </div>
              </div>
            </a>
          </article>
