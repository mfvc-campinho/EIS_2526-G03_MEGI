<!DOCTYPE html>
<!--
  File: public_html/HTML/all_collections.html
...
<body>
  <div id="content">
    ...
    <main>
      ...
      <!-- CRUD buttons (same style as Home) -->
      ...
      <div class="filter-section" role="region" aria-label="Filter collections">
        <div class="filter-control">
          ...
          <div class="filter-input" data-filter-for="collections-list">
            ...
            <button id="clearFilter" class="filter-clear" title="Reset filter"><i class="bi bi-x-lg"
