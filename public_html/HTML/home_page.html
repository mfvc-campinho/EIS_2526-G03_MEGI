<!DOCTYPE html>
<!--
  File: public_html/HTML/home_page.html
  ...
  Notes: JS expects #homeCollections and modals such as #collection-modal to exist.
-->
<html lang="en">
...
<body>
  <div id="content">
    ...
    <header>
      <nav class="navbar">
        <div class="nav-left">
          <a href="home_page.html" class="logo" aria-current="page">
    ...
    <main>
      ...
      <section class="filter-section">
        ...
        <div class="filter-control">
          <label for="rankingFilter" class="filter-label"><i class="bi bi-funnel me-1" aria-hidden="true"></i>Sort
            by</label>
    ...
    <section class="upcoming-events">
      <div class="upcoming-inner">
        ...
        <div class="events-actions">
          <a href="event_page.html" class="explore-btn ghost">View Events</a>
        </div>
      </div>
    </section>
